...
<head>
    ...
    <title>Contact Page - Boris</title>
...
<nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="/">Boris Vojinović</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                @if(Auth::user())
                    ...
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{route('logout-user')}}">Logout</a></li>
                @else
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <p>Want to get in touch? Fill out the form below to send me a message and I will get back to you as
                        soon as possible!</p>
                    <div class="my-5">
                        <form id="contactForm" method="POST" action="{{ route('sendEmail') }}" data-sb-form-api-token="API_TOKEN">
                            @csrf
